...
#define _DUTY_MAX 2140 // 2000
#define _DUTY_NEU 1502 // 1500
#define _DUTY_MIN 683 // 1000

#define _SERVO_ANGLE_DIFF  90  // Replace with |D - E| degree
#define _SERVO_SPEED       300  // servo speed

#define _BANGBANG_RANGE    7  // duty up and down for bangbang control
...
float volt_to_distance(int a_value)
{
  ...
  float x = a_value;
  return 933 + -5.15*x + 0.0101*x*x + -6.9E-06*x*x*x;
}
